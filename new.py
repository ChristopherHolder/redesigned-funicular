...
def train_model(model_choice='resnet18', num_epochs=2, batch_size=4, learning_rate=0.001):
...
# Example usage:
train_model(model_choice='resnet18', num_epochs=10, batch_size=128, learning_rate=0.001)
